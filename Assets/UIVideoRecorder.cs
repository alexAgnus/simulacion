...
public class UIVideoRecorder : MonoBehaviour
{
	// Public Properties
	...
	void Start()
	{
		...
		string logCreationDate = DateTime.Now.ToString("yyyy-MM-dd");
		...
		persistentDataPath = $"{path}\\ScreenRecorder\\{_userRecord.userId}";

		print("[UIVideoRecorder] Capturing to: " + persistentDataPath);
